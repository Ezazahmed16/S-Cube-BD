                ...
                <section style={{ color: "#D5A01E" }} className="py-6">
                    <div className="container p-4 mx-auto">
                        <div className="space-y-4">
                            ...
                            <p className="text-gray-400 text-center pb-5">Meet Our Team</p>
                        </div>

                        <div className="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">

                            <div data-aos="zoom-in-down" className="space-y-4">
                                <img alt="" className="object-cover h-56 mx-auto mb-4 bg-center rounded-sm bg-gray-500" src="https://cdn.pixabay.com/photo/2023/08/15/09/21/camera-8191564_640.jpg" />
