                    ...
                    <div style={{ color: "#FBC80B" }} className="py-6">
                        <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                            <div className="py-6 md:py-0 md:px-6">
                                ...
                                <p className='mb-2'>
                                    Your experiences with our apparel mean everything to us. Share the joy of feeling good and expressing yourself. Your thoughts and ideas are the inspiration behind creating new products designed for you to love, wear, and share. Let's collaborate on bringing your vision to life!
                                    Sustainability
                                </p>
